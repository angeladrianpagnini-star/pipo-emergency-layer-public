(function () {
  ...
  const copy = {
    "es-AR": {
      ...
      lead: "Una demostración guiada de cómo una alerta ciudadana puede llegar a una consola maestra, coordinar organismos en paralelo, documentar intervenciones y devolver un cierre comprensible.",
      start: "Iniciar demostración guiada",
      next: "Siguiente paso",
      previous: "Paso anterior",
      restart: "Reiniciar",
      progress: "Paso {current} de 8 - {label}",
      step1: "Activación ciudadana",
      step2: "Recepción maestra",
      step3: "Derivación simultánea",
      step4: "Asignación de recursos",
      step5: "Intervención de campo",
      step6: "Documentación",
      step7: "Cierre institucional",
      step8: "Devolución ciudadana",
      scenario: "Escenario de demostración",
      scenarioTitle: "Accidente vial con respuesta coordinada",
      scenarioLead: "Persona lesionada, posible derrame, riesgo de incendio y necesidad de ordenar el tránsito.",
      demoOnly: "Todo lo mostrado es simulado. No se usan sensores, ubicación, medios ni servicios de emergencia reales.",
      citizenZone: "A. Dispositivo ciudadano",
      masterZone: "B. Coordinación institucional",
      fieldZone: "C. Recursos de campo",
      pipoPoint: "Punto PIPO",
      demoCitizen: "Persona usuaria demo",
      demoRegion: "Argentina - Buenos Aires",
      internationalRegion: "Demostración internacional",
      citizenAlert: "Accidente vial",
      citizenReport: "Colisión simulada. Hay una persona lesionada, posible derrame y circulación comprometida.",
      simulatedLocation: "Ubicación simulada",
      ...
      connected: "Conexión simulada activa",
      ...
      highPriority: "Alta - validación humana requerida",
      risks: "Riesgos detectados",
      riskList: "Persona lesionada, posible derrame, riesgo de incendio y tránsito afectado.",
      missing: "Datos faltantes",
      missingList: "Cantidad de vehículos y condiciones del derrame.",
      ...
      routeNote: "La derivación puede ocurrir de manera simultánea a varios organismos.",
      ...
      traffic: "Tránsito",
      fire: "Bomberos",
      internationalSecurity: "Seguridad pública",
      internationalHealth: "Salud de emergencia",
      internationalTraffic: "Gestión vial",
      internationalFire: "Respuesta contra incendios",
      alertReceived: "Alerta recibida",
      informationShared: "Información compartida",
      ...
      pendingHumanConfirmation: "Pendiente de confirmación humana",
      selectionRule: "PIPO sugiere recursos mediante proximidad simulada, especialidad, disponibilidad, jurisdicción y prioridad. La asignación final requiere confirmación humana.",
      assignmentRequired: "Confirme los recursos sugeridos antes de continuar con la intervención de campo.",
      criteria: "Criterios de selección",
      criteriaList: "Cercanía simulada, especialidad, disponibilidad, jurisdicción, prioridad y capacidad requerida.",
      mapTitle: "Mapa operativo simulado",
      mapLead: "Representación abstracta sin coordenadas, ubicación real ni servicios externos.",
      incident: "Incidente",
      ...
      eta: "Arribo estimado",
      jurisdiction: "Jurisdicción simulada",
      ...
      action: "Actuación simulada",
      evidence: "Evidencia simulada",
      support: "Solicitar apoyo",
      finish: "Finalizar intervención",
      fieldContext: "Contexto simulado compartido con autorización del usuario. No se utilizan sensores reales.",
      documentsTitle: "Actas individuales e integración documental",
      documentsLead: "Cada organismo conserva su propia autoría. La consola maestra integra referencias sin reescribir fuentes.",
      individualAct: "Acta Individual de Intervención",
      author: "Autor",
      version: "Versión",
      time: "Hora simulada",
      integrity: "Referencia de integridad",
      source: "Fuente",
      actReady: "Acta lista para integración",
      integration: "Actas individuales -> Acta Digital de Procedimiento -> Expediente maestro -> Cierre trazable",
      noAbsorption: "Integración sin absorción documental.",
      closureTitle: "Cierre institucional",
      closureLead: "La consola maestra valida documentos y separa el material entregable de la información restringida.",
      validateClosure: "Validar cierre",
      closureReady: "Cierre trazable validado por operador humano.",
      closureFlowMaster: "Consola maestra",
      closureFlowValidation: "Validación del cierre",
      closureFlowPackage: "Paquete ciudadano",
      closureFlowDevice: "Dispositivo ciudadano",
      packageTitle: "Devolución ciudadana simulada",
      packageLead: "El dispositivo recibe un resumen claro, próximos pasos y solo documentos habilitados.",
      ...
      nextMedicalStep: "Próximo paso médico",
      referenceNumber: "Número de referencia",
      followUpOwner: "Organismo responsable del seguimiento",
      followUpValue: "107 Salud - seguimiento clínico simulado",
      packageIntegrity: "Referencia de integridad",
      receiptConfirmation: "Confirmación de recepción",
      receiptPending: "Pendiente de confirmación",
      packageReceived: "Paquete ciudadano recibido",
      documentationAvailable: "Documentación disponible",
      followUpPending: "Seguimiento pendiente",
      emergencySessionEnded: "Sesión de emergencia finalizada",
      viewSummary: "Ver resumen",
      viewDocuments: "Ver documentos",
      nextSteps: "Próximos pasos",
      confirmReceipt: "Confirmar recepción",
      observation: "Presentar observación",
      packageDelivered: "Paquete ciudadano simulado entregado. La información restringida no se muestra.",
      eventLedger: "Bitácora del recorrido operativo",
      noEvents: "Inicie la demostración para ver eventos simulados append-only.",
      operationMessage: "",
      emergencyHealth: "Atención prehospitalaria",
      securitySupport: "Seguridad de escena",
      trafficOrder: "Ordenamiento vial",
      fireResponse: "Prevención de incendio",
      medicalCare: "Atención a persona lesionada",
      sceneSecurity: "Resguardo del lugar",
      trafficControl: "Control de circulación",
      spillAndFireRisk: "Control de derrame y riesgo de incendio",
      healthOperator: "Operadora 107 Demo",
      securityOperator: "Oficial Móvil Demo",
      trafficOperator: "Agente Tránsito Demo",
      fireOperator: "Jefe de Dotación Demo",
      healthMapUnit: "Ambulancia 107-04",
      securityMapUnit: "Móvil 911-12",
      trafficMapUnit: "Unidad T-08",
      fireMapUnit: "Dotación B-03",
      healthSelectionCriterion: "Cercanía + capacidad sanitaria",
      securitySelectionCriterion: "Jurisdicción + prioridad",
      trafficSelectionCriterion: "Mayor proximidad",
      fireSelectionCriterion: "Capacidad especializada",
      fieldInstruction: "Prioridad de vida, seguridad de escena y coordinación interinstitucional.",
      packageActions: "Asistencia sanitaria iniciada, escena resguardada, tránsito ordenado y riesgo de incendio contenido.",
      packageDocuments: "Resumen ciudadano y constancia de atención simulada.",
      packageNext: "Continuar control médico según indicación del equipo tratante.",
      status: "Estado",
      guidedMessage: "La demostración guiada enfoca la etapa actual; los cambios son solo visuales y de demostración.",
  ...
  function renderTemplate() {
    ...
    return `
      <section class="journey-shell" aria-labelledby="journeyTitle">
        ...
        ${state.locale === "es-AR" ? `<details class="journey-advanced-link"><summary>${text("advanced")}</summary><p>${text("demoOnly")}</p><button type="button" data-journey-action="advanced">${text("advanced")}</button></details>` : ""}
      </section>`;
  }
