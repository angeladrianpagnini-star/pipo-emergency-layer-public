(function () {
  ...
  const copy = {
    "es-AR": {
      documentTitle: "PIPO Emergency Layer - Activación ciudadana simulada",
      eyebrow: "Aplicación de emergencia proyectada",
      headline: "PIPO Emergency Layer",
      tagline: "Ayuda inmediata. Contexto en tiempo real. Procedimientos trazables.",
      description: "Aplicación de emergencia que conecta al ciudadano con operadores y organismos mediante una alerta estructurada, comunicación segura y documentación integral del incidente.",
      activation: "Ver activación ciudadana",
      coordination: "Explorar coordinación institucional",
      language: "Cambiar idioma",
      localeLabel: "Idioma / Language",
      regionLabel: "Región operativa",
      productNote: "PIPO se proyecta como una aplicación descargable de activación inmediata.",
      compatibility: "En Android compatible puede utilizar un punto flotante autorizado. En otros sistemas, la activación se adapta a widget, pantalla bloqueada, control del sistema, acceso directo o botón de acción. La disponibilidad depende del sistema operativo y de los permisos.",
      simulation: "Demo conceptual: no instala una aplicación nativa ni activa sensores, ubicación, cámara o micrófono reales.",
      howTitle: "Así utiliza PIPO una persona",
      howLead: "La persona sigue usando la aplicación que tenía abierta y accede a una capa de emergencia cuando la necesita.",
      deviceScreen: "Pantalla ficticia de mensajería",
      emergencyAvailable: "Acceso de emergencia disponible",
      simulated: "Simulación visual",
      openAccess: "Abrir punto PIPO",
      closeAccess: "Cerrar punto PIPO",
      chooseEmergency: "Elegir condición de emergencia",
      permissionsTitle: "Confirmar alerta simulada",
      selectedCondition: "Condición seleccionada",
      shareDuring: "Compartir durante este incidente",
      permissionLocation: "Ubicación simulada",
      permissionAudio: "Audio simulado",
      permissionVideo: "Video simulado",
      permissionDescription: "Descripción escrita",
      permissionDevice: "Información de dispositivo ficticio",
      permissionNote: "Los permisos se aplican únicamente a esta demostración y a este incidente simulado.",
      cancel: "Cancelar",
      startAlert: "Iniciar alerta simulada",
      sessionTitle: "Sesión de emergencia simulada",
      sessionLead: "La interfaz representa el contexto que podría documentarse antes del arribo. No transmite medios ni datos reales.",
      simulatedVideo: "Video simulado",
      abstractSignal: "Señal abstracta sin imagen de personas",
      simulatedAudio: "Audio simulado",
      simulatedMap: "Ubicación simulada",
      elapsed: "Tiempo transcurrido",
      incident: "Identificador del incidente",
      operator: "Operador conectado",
      receivingAgency: "Organismo receptor",
      routing: "Estado de derivación",
      ...
      documented: "Sesión documentada",
      stopAudio: "Detener audio",
      stopVideo: "Detener video",
      stopLocation: "Dejar de compartir ubicación",
      endSession: "Finalizar transmisión",
      waiting: "En espera de activación simulada",
      active: "Activa",
      inactive: "No compartida",
      receptionTitle: "Recepción institucional",
      receptionLead: "El contexto simulado llega a una consola antes de la intervención en campo y queda asociado al incidente de demostración.",
      ...
      aiNotice: "La IA no activa sensores. La persona inicia la sesión y selecciona explícitamente qué información simulada comparte. Las decisiones operativas permanecen bajo control humano.",
      ...
      advanced: "Ver módulos avanzados",
      technical: "Información técnica de Build Week",
      technicalLead: "Contexto de desarrollo, preservación de v36, rama y módulos de demostración.",
      advancedLead: "Consolas, actas, bitácora y controles técnicos de la demostración.",
      navActivation: "Activación ciudadana",
      ...
      international: "Demostración internacional",
      general: "Emergencia general",
      health: "Salud",
      fire: "Incendio",
      violence: "Violencia o género",
      childhood: "Niñez",
      traffic: "Accidente vial",
      cyber: "Ciberdelito",
      stolen: "Dispositivo robado",
      cannotSpeak: "No puedo hablar",
      noCondition: "Aún no se seleccionó una condición.",
      alertStarted: "Alerta simulada iniciada. No se activaron sensores reales.",
      alertCancelled: "Selección de alerta cancelada.",
      sessionEnded: "Transmisión simulada finalizada. La bitácora conserva los eventos de demostración.",
      permissionEnabled: "permiso seleccionado para la demostración",
      permissionDisabled: "permiso retirado de la demostración",
      mediaStopped: "medio simulado detenido",
      locationStopped: "ubicación simulada dejada de compartir",
      regionArgentinaAgency: "911 Seguridad / 107 Salud",
      regionInternationalAgency: "Centro de respuesta de demostración",
      agencyArgentina: "911 Seguridad, 107 Salud, Bomberos y Defensa Civil",
      agencyInternational: "Seguridad pública, salud de emergencia, bomberos y protección civil",
      priorityValue: "Prioridad inicial para validación humana",
      eventLedger: "Bitácora de activación simulada",
      noEvents: "No hay eventos de activación todavía.",
      statusWaiting: "La consola espera una alerta simulada.",
      statusReceived: "Alerta simulada recibida y preparada para coordinación humana.",
      languageSpanish: "Español (Argentina)",
      languageEnglish: "English (United States)",
      technicalNav: "Navegación técnica",
          ...
          <div class="pipo-device-layout">
            <div class="pipo-phone" aria-label="${text("deviceScreen")}">
              ...
              <div class="pipo-phone-app">
                ...
                <div class="pipo-chat-line"><i></i><span>${state.locale === "es-AR" ? "Grupo comunitario" : "Community group"}<small>${state.locale === "es-AR" ? "Reunión en el punto habitual" : "Meeting at the usual place"}</small></span></div>
                ...
                <div class="pipo-chat-line"><i></i><span>${state.locale === "es-AR" ? "Actividad local" : "Local activity"}<small>${state.locale === "es-AR" ? "Actualización de demostración" : "Demonstration update"}</small></span></div>
              </div>
  ...
  function legacyHeadingLabels() {
    return {
      ...
      "PIPO Evidence Vault": {
        "es-AR": "Bóveda de evidencia PIPO",
      ...
      "Digital Acquisition Records": {
        "es-AR": "Registros de adquisición digital",
      ...
      "Field Operator Mobile": {
        "es-AR": "Móvil del operador de campo",
